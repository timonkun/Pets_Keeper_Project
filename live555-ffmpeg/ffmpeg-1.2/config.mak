...
CC_IDENT=gcc 4.4.1 (Sourcery G++ Lite 2009q3-67)
ARCH=arm
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -L/home/timonkun/Workspace/webcam_project/live555-ffmpeg/ffmpeg_install/lib  -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
EXTRALIBS=-ldl -lx264 -lm -pthread -lz -lrt 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
